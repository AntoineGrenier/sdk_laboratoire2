        ...
        public string AlphaToNote(string str)
        {
            ...
            switch (str.ToUpperInvariant())
            {
                ...
                default: //Valeur n'est pas dans la liste du haut
                    strReturnValue = "La lettre n'existe pas. Entrer une lettre de votre choix entre A, B, C, D, E, F ou G.:";
                    break;
            }
            //Retourne la valeur
        ...
        public string NoteToAlpha(string str)
        {
            ...
            switch (str.ToUpperInvariant())
            {
                ...
                case "SOL":
                    ...
                    break;
                default:
                    strReturnValue = "La note n'existe pas. Entrer une note de votre choix entre DO, RE, MI, FA, SOL, LA ou SI. : ";
                    break;
            }
            return strReturnValue;
        }
